 ...
 * @author sdhil
 */
public class riskMain1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(topBar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1920, 80));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(riskMain1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
